...
4. **Thought rooms** - a board of independent modules. Each room is a button that opens a read-only status trace and lets its process add an internal note to the terminal.
